...
/* USER CODE BEGIN PV */
//structs to hold date and time
RTC_TimeTypeDef rtcTime;
RTC_DateTypeDef rtcDate;
//character arrays for translating to UART
char tchar[20];
char dchar[20];
...
int main(void)
{
  /* USER CODE BEGIN 1 */
	...
	/*This block is unfinished, attempt to grab (correct) local time
	char *timestr;
	struct date* l_time;
